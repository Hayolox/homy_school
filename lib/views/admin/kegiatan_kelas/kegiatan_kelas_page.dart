      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Consumer<ClassActivitiesViewModel>(
                builder: (context, value, child) {
              return StreamBuilder(
                stream: value.getData(),
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.active) {
                    var allDataClassActivities = snapshot.data!.docs;
                    return Expanded(
                      child: ListView.builder(
                        itemCount: allDataClassActivities.length,
                                  ...
                                  return AlertDialog(
                                    ...
                                    actions: [
                                      ...
                                      ElevatedButton(
                                        onPressed: () {
                                          value.deleteData(
                                              allDataClassActivities[index].id);
                                          Navigator.pop(context);
                                        },
                                        style: ElevatedButton.styleFrom(
                                            backgroundColor: lavenderColor),
                              ...
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) => DetailKegiatanPage(
                                      idDoc: allDataClassActivities[index].id),
                                ),
                              );
                            },
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Expanded(
                                    flex: 1,
                                    child: Text(
                                      "${(allDataClassActivities[index].data() as Map<String, dynamic>)['name']}",
                                  ...
                                  Expanded(
                                    flex: 2,
                                    child: Text(
                                      "${(allDataClassActivities[index].data() as Map<String, dynamic>)['description']}",
                                      overflow: TextOverflow.ellipsis,
